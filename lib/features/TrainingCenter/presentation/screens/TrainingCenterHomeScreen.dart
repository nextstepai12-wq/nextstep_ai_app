// lib/features/TrainingCenter/presentation/screens/training_center_home_screen.dart
...
import '../blocs/training_programs_bloc/training_programs_bloc.dart';
      ...
      Stack(
        children: [
          IconButton(
            ...
            onPressed: () {
              // ✅ استخدم pushNamed
              Navigator.pushNamed(context, '/training-center/notifications');
            },
      ...
      children: [
        Row(
          ...
          children: [
            ...
            TextButton(
              onPressed: () {
                Navigator.pushNamed(context, '/training-center/programs');
              },
