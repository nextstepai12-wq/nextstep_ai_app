...
class _NotificationsScreenState extends State<NotificationsScreen>
  ...
  final List<Map<String, dynamic>> _dummyNotifications = [
    {
      'id': 1,
      'title': 'توصية جديدة! 🎉',
      'body': 'تم إضافة تخصص "هندسة الحاسوب" كتوصية مناسبة لك بنسبة 92%',
    ...
    },
    {
      ...
      'body': 'تم إضافة 5 تخصصات جديدة في الجامعة الإسلامية',
    ...
    },
    {
      ...
      'body': 'لم تكمل الاستبيان الذكي بعد! أكمل الآن للحصول على توصيات دقيقة',
    ...
    },
    {
      ...
      'body': 'تم فتح باب التقديم لمنحة دراسية في جامعة الأزهر - سارع بالتسجيل',
    ...
    {
      'id': 5,
      'title': 'مرحباً بك في NextStep AI',
      'body': 'نحن سعداء بانضمامك إلينا! اكتشف مسارك الأكاديمي معنا',
  ...
  Future<void> _refreshNotifications() async {
    ...
    final newNotification = {
      ...
      'title': 'إشعار جديد! 🔔',
      'body': 'هذا إشعار تم إضافته أثناء التحديث',
      'time': DateTime.now(),
      'isRead': false,
      'isImportant': false,
      'type': 'new',
            ...
            _buildMenuItem(
              ...
              onTap: () {
                ...
                setState(() {
                  ...
                  if (index != -1) {
                    _notifications[index]['isImportant'] = !(_notifications[index]['isImportant'] as bool);
                  }
                });
              },
            ),
