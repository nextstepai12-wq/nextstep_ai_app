...
class UniversitySettingsScreen extends StatefulWidget {
  const UniversitySettingsScreen({super.key});

  @override
  State<UniversitySettingsScreen> createState() =>
      _UniversitySettingsScreenState();
}

class _UniversitySettingsScreenState extends State<UniversitySettingsScreen>
  ...
  Widget _buildProfileCard() {
    return InkWell(
      onTap: () => Navigator.pushNamed(context, '/university/profile'),
    ...
    return _buildSection(
      ...
      children: [
        _buildSwitchTile(
          ...
          title: 'الإشعارات',
          subtitle: 'تلقي إشعارات الطلاب والتحديثات',
      ...
      children: [
        _buildSwitchTile(
          ...
          onChanged: (value) {
            ...
            _showSnackBar(value ? 'تم تفعيل الوضع الليلي' : 'تم إيقاف الوضع الليلي');
          },
        ),
        _buildLanguageTile(),
        _buildThemeTile(),
    ...
    return _buildSection(
      ...
      children: [
        ...
        _buildNavigateTile(
          ...
          onTap: () => _launchURL('https://nextstepai.com/privacy'),
        ),
        _buildNavigateTile(
          icon: Icons.description_rounded,
          title: 'الشروط والأحكام',
          subtitle: 'اتفاقية استخدام التطبيق',
          onTap: () => _launchURL('https://nextstepai.com/terms'),
        ),
        _buildNavigateTile(
          icon: Icons.cookie_rounded,
          title: 'سياسة ملفات تعريف الارتباط',
          subtitle: 'كيف نستخدم ملفات الكوكيز',
          onTap: () => _launchURL('https://nextstepai.com/cookies'),
        ),
      ],
    );
  }
    ...
    return _buildSection(
      ...
      children: [
        ...
        _buildNavigateTile(
          ...
          onTap: () => Navigator.pushNamed(context, '/share-app'),
        ),
      ],
    );
  }
