...
Future<void> main() async {
  ...
  // ✅ تهيئة Supabase مع المفاتيح الصحيحة
  await Supabase.initialize(
    url: 'https://raevfbjqxgrikyxnkcta.supabase.co',
    publishableKey: 'sb_publishable_VBD0w2P4YFcjDafSTk8INQ_KThs3KIR', // ✅ استخدم publishableKey بدلاً من anonKey
  );

  // ✅ التحقق من وجود جلسة
  final isLoggedIn = await TokenManager.isLoggedIn();
  final initialRoute = isLoggedIn ? '/student' : '/splash';
